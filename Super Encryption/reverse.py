...
def substitusi_encript(plaintext):
...
# Encryption
def orthogonal_encrypt():  # Fungsi untuk enkripsi
    plain_text = input("masukkan plain text : ")
    step_size = int(input("Masukkan kunci(angka) : "))
...
# Decryption
def orthogonal_decrypt(cipher_text):  # Fungsi untuk dekripsi
...
def substitusi_decript():
    msg = input("Masukkan Cipher text : ")
...
def main():
    while (1):
        ...
        if choice == 1:
            ...
            print("cipher text : ",substitusi_encript(orthogonal_encrypt()))
        elif choice == 2:
            print("----------------")
            ...
            print("plain text : ",orthogonal_decrypt(substitusi_decript()))
